...
public class mxObjectCodec
{
	...
	private mxObjectCodecProduct mxObjectCodecProduct = new mxObjectCodecProduct();

	public static final Logger log = Logger.getLogger(mxObjectCodec.class.getName());
		...
		while (type != null)
		{
			...
			for (int i = 0; i < fields.length; i++)
			{
				...
				if ((f.getModifiers() & Modifier.TRANSIENT) != Modifier.TRANSIENT)
				{
					...
					Object value = mxObjectCodecProduct.getFieldValue(obj, fieldname);
			...
			Object value, Node node)
	{
		if (value != null && !isExcluded(obj, fieldname, value, true))
		{
			...
			Object defaultValue = mxObjectCodecProduct.getFieldValue(template, fieldname);
	...
	{
		return mxObjectCodecProduct.convertValueFromXml(type, value);
	}
	...
	{
		return mxObjectCodecProduct.getField(obj, fieldname);
	}
	...
	{
		return mxObjectCodecProduct.getAccessor(obj, field, isGetter);
	}
	...
	{
		return mxObjectCodecProduct.getMethod(obj, methodname, params);
	}
	...
	{
		return mxObjectCodecProduct.getFieldValue(obj, fieldname);
	}
	...
	{
		return mxObjectCodecProduct.getFieldValueWithAccessor(obj, field);
	}
	...
	{
		mxObjectCodecProduct.setFieldValue(obj, fieldname, value);
	}
	...
	protected void setFieldValueWithAccessor(Object obj, Field field,
			Object value)
	{
		mxObjectCodecProduct.setFieldValueWithAccessor(obj, field, value);
	}
	...
	protected void decodeChild(mxCodec dec, Node child, Object obj)
	{
		...
		{
			Object template = mxObjectCodecProduct.getFieldTemplate(obj, fieldname, child);
			Object value = null;
	...
	{
		return mxObjectCodecProduct.getFieldTemplate(obj, fieldname, child);
	}
